	            ...
	            <ul class="nav navbar-top-links navbar-right">
	                ...
	                <li class="dropdown">
	                    ...
	                    <ul class="dropdown-menu dropdown-user">
	                        ...
	                        <li class="divider"></li>
	                        <li><a href="<%=contextPath %>/inner/logout"><i class="fa fa-sign-out fa-fw"></i> 退&nbsp;出</a>
	                        </li>
	                    </ul>
	                    <!-- /.dropdown-user -->
	                </li>
	            ...
	            <div class="navbar-default sidebar" role="navigation">
	                <div class="sidebar-nav navbar-collapse">
	                    <ul class="nav" id="side-menu">
	                        <li>
	                            <a href="javascript:;"><i class="fa fa-bar-chart-o fa-fw"></i> 基础信息<span class="fa arrow"></span></a>
	                            <ul class="nav nav-second-level collapse">
	                                <li>
	                                    <a id="a_loadAirports" href="javascript:;">机场信息</a>
	                                </li>
	                                <li>
	                                    <a id="a_loadCarriers" href="javascript:;">航空公司</a>
	                                </li>
	                                <li>
	                                    <a id="a_loadPassengerGauges" href="javascript:;">航空客规</a>
	                                </li>
	                                <li>
	                                    <a id="a_loadAircraftTypes" href="javascript:;">机型信息</a>
	                                </li>
	                            </ul>
	                            <!-- /.nav-second-level -->
	                        </li>
	                        <li>
	                            <a id="a_loadCustomers" href="javascript:;"><i class="fa fa-dashboard fa-fw"></i> 客户信息</a>
	                        </li>
	                        <li>
	                            <a id="a_loadSalesmans" href="javascript:;"><i class="fa fa-table fa-fw"></i> 客服信息</a>
	                        </li>
	                        <li>
	                            <a id="a_loadOperatingLogs" href="javascript:;"><i class="fa fa-edit fa-fw"></i> 操作日志</a>
	                        </li>
	                    </ul>
	                </div>
	                <!-- /.sidebar-collapse -->
